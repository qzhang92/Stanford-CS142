...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<activeresource>, ["= 3.2.1"])
      s.add_runtime_dependency(%q<actionmailer>, ["= 3.2.1"])
      s.add_runtime_dependency(%q<railties>, ["= 3.2.1"])
      s.add_runtime_dependency(%q<bundler>, ["~> 1.0"])
    else
      s.add_dependency(%q<activesupport>, ["= 3.2.1"])
      s.add_dependency(%q<actionpack>, ["= 3.2.1"])
      s.add_dependency(%q<activerecord>, ["= 3.2.1"])
      s.add_dependency(%q<activeresource>, ["= 3.2.1"])
      s.add_dependency(%q<actionmailer>, ["= 3.2.1"])
      s.add_dependency(%q<railties>, ["= 3.2.1"])
