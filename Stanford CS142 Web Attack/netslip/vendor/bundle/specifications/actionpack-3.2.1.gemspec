# -*- encoding: utf-8 -*-
# stub: actionpack 3.2.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<rack-cache>.freeze, ["~> 1.1"])
      ...
      s.add_runtime_dependency(%q<journey>.freeze, ["~> 1.0.1"])
      s.add_runtime_dependency(%q<sprockets>.freeze, ["~> 2.1.2"])
      ...
      s.add_dependency(%q<journey>.freeze, ["~> 1.0.1"])
      s.add_dependency(%q<sprockets>.freeze, ["~> 2.1.2"])
