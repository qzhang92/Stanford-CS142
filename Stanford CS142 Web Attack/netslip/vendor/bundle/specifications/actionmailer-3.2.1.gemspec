# -*- encoding: utf-8 -*-
# stub: actionmailer 3.2.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<actionpack>.freeze, ["= 3.2.1"])
      s.add_runtime_dependency(%q<mail>.freeze, ["~> 2.4.0"])
    else
      s.add_dependency(%q<actionpack>.freeze, ["= 3.2.1"])
      s.add_dependency(%q<mail>.freeze, ["~> 2.4.0"])
    end
  else
    s.add_dependency(%q<actionpack>.freeze, ["= 3.2.1"])
    s.add_dependency(%q<mail>.freeze, ["~> 2.4.0"])
